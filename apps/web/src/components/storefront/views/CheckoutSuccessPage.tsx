    ...
    <>
      ...
      <main className="max-w-md mx-auto px-4 py-16 text-center">
        ...
        <p className="mt-3 text-muted-foreground">
          Your payment went through. A confirmation email is on the way once the order finishes
          processing (usually a few seconds).
        </p>
        {sessionId && (
          <p className="mt-4 text-xs text-muted-foreground font-mono break-all">Reference: {sessionId}</p>
        )}
        <Link
          href={`${base}/products`}
